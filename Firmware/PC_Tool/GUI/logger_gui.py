...
Combines datalogger_cli and plotter functionality in a user-friendly GUI
"""
...
# Import your existing CLI modules (adapted inline for this example)
# In practice, you'd import from datalogger_cli and PlotterV3


class LoggerGUI:
    def __init__(self, root):
        self.root = root
        self.root.title("ESP32 DataLogger - Configuration & Analysis")
    ...
    def create_data_tab(self):
        ...
        # Available logs
        list_frame = ttk.LabelFrame(frame, text="Available Logs", padding=10)
        ...
        for col in columns:
            ...
            self.dates_tree.column(col, width=150)
    ...
    def download_selected(self):
        ...
        def download():
            try:
                ...
                self.root.after(0, lambda: self.status_bar.config(text=f"Downloaded {date}"))
            except Exception as e:
    ...
    def plot_selected(self):
        ...
        # Download to temp file and plot
        import tempfile
        ...
        def download_and_plot():
            try:
                ...
                # Load and plot
                self.root.after(0, lambda: self.load_and_plot_file(temp_path))
